...
Agents are powered via **MiniMax** by default through its OpenAI-compatible API endpoint and can be pointed at any compatible provider if needed.
...
- Node.js 18+
- [MiniMax](https://platform.minimax.io) API key
