...
export function getScheduleMenuMarkup() {
  return keyboard([
    [TELEGRAM_LABELS.MGMT_MANUAL, TELEGRAM_LABELS.MGMT_15M, TELEGRAM_LABELS.MGMT_30M],
    [TELEGRAM_LABELS.SCREEN_MANUAL, TELEGRAM_LABELS.SCREEN_30M, TELEGRAM_LABELS.SCREEN_60M],
